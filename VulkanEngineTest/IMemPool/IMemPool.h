...
{
	template <typename T>
	struct pointer_traits<IUserPtr<T>> {
		using pointer = IUserPtr<T>;
		using element_type = T;
		using difference_type = std::ptrdiff_t;

		template <typename U>
		using rebind = IUserPtr<U>;
	...
	template <>
	struct pointer_traits<IUserPtr<void>> {
		using pointer = IUserPtr<void>;
	...
	template <>
	struct pointer_traits<IUserPtr<const void>> {
		using pointer = IUserPtr<const void>;
