...
int STLUsePoolTest()
{
    ...
    using MapAlloc = IMemPoolAllocator<std::pair<const std::string, MyStruct>>;
    MapAlloc alloc(pool);
    using MapAlloc2 = IMemPoolAllocatorOnlyFixedBlock<std::pair<const std::string, MyStruct2>>;
